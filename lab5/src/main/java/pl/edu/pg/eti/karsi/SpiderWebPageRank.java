...
public class SpiderWebPageRank extends Configured implements Tool {
    public static void main(String[] args) throws Exception {
        ToolRunner.run(new Configuration(), new SpiderWebPageRank(), args);
    }
    ...
    private void createInitialJob(String[] args) throws Exception {
        ...
        job.setJarByClass(SpiderWebPageRank.class);
    ...
    private static class CalculatePageRankReducer extends Reducer<Text, Text, Text, Text> {
        ...
        protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            totalChance = b * totalChance + (1 - b) / n;
